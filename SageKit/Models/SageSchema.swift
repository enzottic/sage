...
public class SageSchemaMigrationPlan: SchemaMigrationPlan {
    public static var schemas: [any VersionedSchema.Type] = [SageSchemaV1.self, SageSchemaV2.self, SageSchemaV3.self, SageSchemaV4.self, SageSchemaV5.self, SageSchemaV6.self]
...
public typealias Expense = SageSchemaV6.Expense
public typealias ExpenseTag = SageSchemaV6.ExpenseTag
