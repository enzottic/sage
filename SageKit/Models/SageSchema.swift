...
public class SageSchemaMigrationPlan: SchemaMigrationPlan {
    public static var schemas: [any VersionedSchema.Type] = [SageSchemaV1.self, SageSchemaV2.self, SageSchemaV3.self]
...
public typealias Expense = SageSchemaV3.Expense
public typealias ExpenseTag = SageSchemaV3.ExpenseTag
public typealias RecurringExpenseRule = SageSchemaV3.RecurringExpenseRule
public typealias RecurrenceFrequency = SageSchemaV3.RecurrenceFrequency
public typealias ExpenseAccount = SageSchemaV3.ExpenseAccount
