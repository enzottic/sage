...
public class SageSchemaMigrationPlan: SchemaMigrationPlan {
    public static var schemas: [any VersionedSchema.Type] = [SageSchemaV1.self, SageSchemaV2.self, SageSchemaV3.self, SageSchemaV4.self, SageSchemaV5.self, SageSchemaV6.self, SageSchemaV7.self, SageSchemaV8.self]
...
public typealias Expense = SageSchemaV8.Expense
public typealias ExpenseTag = SageSchemaV8.ExpenseTag
public typealias RecurringExpenseRule = SageSchemaV8.RecurringExpenseRule
public typealias RecurrenceFrequency = SageSchemaV8.RecurrenceFrequency
public typealias ExpenseAccount = SageSchemaV8.ExpenseAccount
